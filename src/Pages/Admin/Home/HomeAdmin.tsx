...
import Product from '../../../Model/Product';
  ...
  const HomeAdmin = () => {
    ...
    const [deletedProductName, setDeletedProductName] = useState<string | undefined>();
    ...
    return (
      <div className="product-grid">
          <div className="product-container">
            <Button variant="primary" className="add-product-button" onClick={handleAddProduct} disabled={loading}>
              + Add New Product
            </Button>
