        ...
        {({ isSubmitting, errors, touched }) => (
          <Form className='form-position'>
            ...
            <div className="form-group">
              ...
              <Field as="textarea" type="text" id="description" placeholder="Enter Product Description" name="description" className={`form-control-field area ${errors.description && touched.description ? 'is-invalid' : ''}`} />
              <ErrorMessage name="description" component="div" className="invalid-feedback"/>
            </div>
            <div className="form-group">
              <label htmlFor="price">Price</label>
              <Field type="number" id="price" placeholder="0" name="price" className={`form-control-field ${errors.price && touched.price ? 'is-invalid' : ''}`} />
              <ErrorMessage name="price" component="div" className="invalid-feedback"/>
            </div>
            <div className="form-group">
              <label htmlFor="stock">Stock</label>
              <Field type="number" id="stock" placeholder="0" name="stock" className={`form-control-field ${errors.stock && touched.stock ? 'is-invalid' : ''}`} />
              <ErrorMessage name="stock" component="div" className="invalid-feedback"/>
            </div>
            <div className="form-group">
                <label htmlFor="category">Category</label>
                <Field as="select" id="category" name="category" className={`form-control-field ${errors.category && touched.category ? 'is-invalid' : ''}`}>
            ...
            <div className="form-group">
              ...
              <Field type="text" id="brand" placeholder="Enter Product Brand" name="brand" className={`form-control-field ${errors.brand && touched.brand ? 'is-invalid' : ''}`} />
              <ErrorMessage name="brand" component="div" className="invalid-feedback"/>
            </div>
            <div className="form-group">
              <label htmlFor="thumbnail">Thumbnail Image</label>
              <Field type="file" id="thumbnail" accept=".jpeg,.png" name="thumbnail" className={`form-control-field ${errors.thumbnail && touched.thumbnail ? 'is-invalid' : ''}`} />
              <ErrorMessage name="thumbnail" component="div" className="invalid-feedback"/>
            </div>
            <div className="form-group">
